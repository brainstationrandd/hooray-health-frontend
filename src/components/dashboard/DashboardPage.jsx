...
const DashboardPage = () => {
  ...
  // };
  const confirmDeletePdf = async () => {
    // Hide the confirmation dialog right away
  ...
  className="flex items-center gap-2 px-4 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-400 transition duration-200"
>
  <svg 
  ...
  >
    <path 
      fillRule="evenodd" 
      d="M4 2a1 1 0 011-1h10a1 1 0 011 1v1h1a1 1 0 011 1v12a1 1 0 01-1 1H3a1 1 0 01-1-1V4a1 1 0 011-1h1V2zm2 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm0 4a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm0 4a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z" 
      clipRule="evenodd" 
    />
  </svg>
